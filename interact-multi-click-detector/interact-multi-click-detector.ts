...
class InteractMultiClickDetector {
    ...
    private static readonly WINDOW_MS = 1_000; // Time window in milliseconds for a valid multi click sequence.

    private static readonly REQUIRED_CLICKS = 3; // Number of clicks required to trigger a multi click sequence.
